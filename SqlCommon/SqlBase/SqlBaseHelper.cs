...
namespace SqlHelper
{
    ...
    /// SqlServer数据访问帮助类 
    /// </summary> 
    public sealed class SqlBaseHelper
    {
        #region 私有构造函数和方法

        private SqlBaseHelper() { }
        ...
        {
            SqlConnection Connection = new SqlConnection(SqlBaseHelper.GetConnSting());
            return Connection;
        }
        #endregion
        ...
        /// <summary> 
        /// 枚举,标识数据库连接是由SqlBaseHelper提供还是由调用者提供 
        /// </summary> 
        private enum SqlConnectionOwnership
        {
            /// <summary>由SqlBaseHelper提供连接</summary> 
            Internal,
        ...
        /// </summary> 
        /// <remarks> 
        /// 如果是SqlBaseHelper打开连接,当连接关闭DataReader也将关闭. 
        ...
        /// <param name="connectionOwnership">标识数据库连接对象是由调用者提供还是由SqlBaseHelper提供</param> 
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlBaseHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return SqlBaseHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
