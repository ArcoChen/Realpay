...
namespace MerchantPlatformApi.Controllers
{
    ...
    public class CodeServeInfoController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<HttpResponseMessage> CodeServeTable(CodeServiceInfoModel model)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<HttpResponseMessage> CodePurchase(CodeServiceInfoModel model)
        {
            string Result = string.Empty;
