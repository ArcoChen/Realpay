...
{
    public class MerchantRedPacketController : ApiController
    {
        #region 配置参数
        //URL请求所需参数
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage RedPacketApply(AdvertiseMentModel model)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage CommodityCodeReturn(AdvertiseMentModel model)
        {
            string Result = string.Empty;
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage RedPacketNotPass(AdvertiseMentModel model)
        {
            string Result = string.Empty;
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage RedPacketUpdate(AdvertiseMentModel model)
        {
            string Result = string.Empty;
