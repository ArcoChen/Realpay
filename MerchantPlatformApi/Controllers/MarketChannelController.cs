...
namespace MerchantPlatformApi.Controllers
{
    ...
    public class MarketChannelController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<HttpResponseMessage> PartnerMerchantTable(MarketModel model)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<HttpResponseMessage> DeletePartnerMerchant(MarketModel model)
        {
            string Result = string.Empty;
