...
{
    public class CodeInfoController : ApiController
    {
        #region 配置参数
        //URL请求所需参数
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage CodeNumber(UserInfoModel model)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage SoldCode(FaultToleranceModel model)
        {
            string Result = string.Empty;
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage InventoryCode(FaultToleranceModel model)
        {
            string Result = string.Empty;
